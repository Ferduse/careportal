        ...
        <form onSubmit={handleSubmit}>
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              >
                <option value="">Select</option>
                <option value="smoking_history_No">No</option>
                <option value="smoking_history_current">Current</option>
                <option value="smoking_history_ever">Ever</option>
                <option value="smoking_history_former">Former</option>
                <option value="smoking_history_never">Never</option>
